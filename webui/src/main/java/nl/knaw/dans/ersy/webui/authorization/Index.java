...
import nl.knaw.dans.ersy.webui.authorization.pages.AdminAnnotationsBookmarkablePage;
import nl.knaw.dans.ersy.webui.authorization.pages.AdminAnnotationsInternalPage;
 ...
 */
public class Index extends ErsyBasePage
{
	/**
	 * Construct.
	 */
	public Index()
	{
		...
		add(new BookmarkablePageLink<Void>("panelsAnnotPageLink", AdminPanelPage.class));
	}
}

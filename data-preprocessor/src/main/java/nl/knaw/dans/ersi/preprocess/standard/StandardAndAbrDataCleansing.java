...
public class StandardAndAbrDataCleansing {
	private static Logger LOG = LoggerFactory.getLogger(StandardAndAbrDataCleansing.class);
  ...
  public void run() throws IOException, InterruptedException, ClassNotFoundException {
    ...
    //Tokenize text
    DocumentProcessor.tokenizeDocuments(new Path(inputDir), ErsyStemmedAbrAnalyzer.class
  ...
  public static void main(String args[]) throws Exception {
	    ...
	    LOG.debug("==================");
	    LOG.debug("Number of processing data: " + count);
	    LOG.debug("=========END StandardAndAbrDataCleansing=========");
	  }
}

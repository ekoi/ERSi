...
public class StandardDimensionReduction {
  ...
  public static void main(String args[]) throws Exception {
    ...
    String inputDir = "/Users/akmi/tmp/1resuptiontoken/seqdata-from-easy";

    Configuration conf = new Configuration();
    FileSystem fs = FileSystem.get(conf);
 
    String outputDir = "/Users/akmi/tmp/1resuptiontoken/outputdata-from-easy";
    HadoopUtil.delete(conf, new Path(outputDir));
    Path tokenizedPath = new Path(outputDir,
        DocumentProcessor.TOKENIZED_DOCUMENT_OUTPUT_FOLDER);
    //ErsiAnalyzer analyzer = new ErsiAnalyzer();
    //Tokenize text
    DocumentProcessor.tokenizeDocuments(new Path(inputDir), ErsiAnalyzer.class
